...
from icefall.utils import num_tokens, AttributeDict
...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        type=str,
        default="config/ru-datatang_golos_librispeech_rostt_8303h_zipformer_base_online.yaml",
...
def main():
    ...
    params.tokens = Path(params.lang_dir) / 'tokens.txt'
